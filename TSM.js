...
document.querySelector('body').addEventListener('dblclick', (event) => {
	if(event.target.tagName !== "INPUT" && event.target.tagName !== "TEXTAREA" && event.target.tagName !== "BUTTON" && event.target.tagName !== "H1" && event.target.tagName !== "H2" && event.target.tagName !== "H3" && event.target.tagName !== "UL" && event.target.tagName !== "LI" && event.target.tagName !== "VIM-WORD" && event.target.tagName !== "P" && event.target.tagName !== "SPAN" && location.host!='skyeng.autofaq.ai' ){ 

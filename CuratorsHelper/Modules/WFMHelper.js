						...
						<div id="addOperToList">
							    ...
							    <ul id="humansList">
									<li><label name="selectAllWorkersByChanges" style="background-color:Crimson; color:white; padding:2px; border: 1px solid black; padding-left:5px; padding-right:5px;">2/2 | Верхняя смена</label></li>
										<li><label title="⏰ 07:00-19:00 🍔 12:45-14:00"><input type="checkbox" name="upper" value="Зубарев Дмитрий">Зубарев Дмитрий</label></li>
										...
										<li><label title="⏰ 11:00-23:00 🍔 15:45-17:00"><input type="checkbox" name="upper" value="Аркания Георгий">Аркания Георгий</label></li>
										<li><label title="⏰ 11:00-23:00 🍔 15:45-17:00"><input type="checkbox" name="upper" value="Козел Полина">Козел Полина</label></li>
									...
									<li><label name="selectAllWorkersByChanges" style="background-color:DeepSkyBlue; text-align:center; font-weight:700; color:black; padding:2px; padding-left:10px; padding-right:10px; border: 1px solid black;">2/2 | Нижняя смена</label></li>
										<li><label title="⏰ 07:00-19:00 🍔 12:15-13:30"><input type="checkbox" name="lower" value="Лукач Дарья">Лукач Дарья</label></li>
										...
										<li><label title="⏰ 11:00-23:00 🍔 15:45-17:00"><input type="checkbox" name="lower" value="Приблуда Константин">Приблуда Константин</label></li>
										<li><label title="0⏰ 12:00-00:00 🍔 16:45-18:00"><input type="checkbox" name="lower" value="Бахтын Ростислав">Бахтын Ростислав</label></li>

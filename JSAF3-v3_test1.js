...
function move_again_Links() {
    ...
    var listener4 = function(e , a) {
        wintLinks.style.left = Number(e.clientX - myX2) + "px";
        wintLinks.style.top = Number(e.clientY - myY2) + "px";
        localStorage.setItem('winTopLinks', String(Number(e.clientY - myY2)));

        ...
        <span style="width: 301px">
			<span style="cursor: -webkit-grab;">
				<div style="margin: 5px;" id="1str">
					...
					<button id="setting" style="width:15px; float: right; margin-left: 5px">S</button>
					<button id="links" style="width:15px; float: right; margin-left: 5px">L</button>
					<button id="addsrc" style="width:15px; float: right; margin-left: 5px">*</button>

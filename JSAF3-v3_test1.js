...
var win_AFhelper =  // описание элементов главного окна
	...
	<div style="border: 2px double black; display: none; background-color: #464451" id="set_bar">
			<div style="margin: 5px; width: 350px">
				...
				<br>
				<input id="setchas" placeholder="HH" autocomplete="off" type="number" max="23" style="text-align: center; margin-top: 5px; width: 30px; color: black;"> <span style="color: white; margin-top: 5px;">:</span>
				<input id="setminuta" placeholder="MM" autocomplete="off" type="number" max="59" style="text-align: center; margin-top: 5px;  width: 30px; color: black;">

        ...
        <span style="width: 524px">
			<span style="cursor: -webkit-grab;">
				...
				<div style="margin: 5px; width: 520px" id="links_box">
					...
					<input id="setidformobpass" placeholder="not work for now" title="введите ID У/П для генерации разового пароля он будет отображен в поле ввода ID и скопирован в  буфер обмена" autocomplete="off" type="text" style="text-align: center; width: 97px; color: black; margin-top: 5px">

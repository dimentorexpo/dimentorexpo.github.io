                ...
                for (let i = 0; i < data.items.length; i++) {
					...
					//сюда также допилить классы и  менять их в зависимости от темы
						...
						if (data.items[i].channelUser.payload.userFullName == undefined)							
							foundarr += '<span class="chatlist" style="cursor:pointer;">' + day + '.' + month + '.' + year + ' ' + tshrs + ':' + tsmin + ' ' + '<span style ="color:#00BFFF; font-weight:700">' + data.items[i].channelUser.payload.userType + '</span>' + ' ' + data.items[i].channelUser.fullName + '<span style="color: MediumSeaGreen;">' + ' Оценка: ' + '</span>' + marksarr + actstatus + '</span>' + '<br>'								                           
						else
								foundarr += '<span class="chatlist" style="cursor:pointer;">' + day + '.' + month + '.' + year + ' ' + tshrs + ':' + tsmin + ' ' + '<span style ="color:#00BFFF; font-weight:700">' + data.items[i].channelUser.payload.userType + '</span>' + ' ' + data.items[i].channelUser.payload.userFullName + '<span style="color: MediumSeaGreen;">' + ' Оценка: ' + '</span>' + marksarr + actstatus + '</span>' + '<br>'

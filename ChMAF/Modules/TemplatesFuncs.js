...
function requestsRed() { //функция окрашивает в красный цвет, кнопка взять запрос не будет (0) иметь, а любое другое значение
  const taketaskElement = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0].children[1];
...
function startTimer() { // большая функция по таймеру автозакрытия, работой с аудио, добавлением доп кнопок справа в панель информации о пользователе и кнопок быстрого выставления тегов
    ...
    if (localStorage.getItem('audio') == '1') {
			if (window.location.origin.indexOf('https://skyeng.autofaq.ai') !== -1) {
				let btnTakeRequestLink = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0].children[1].textContent;
				if (btnTakeRequestLink) {
...
function transfPageButtons(textFromTable) { //подстановка телефона и почты юзера при использовании шаблона
    ...
    if (document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0].length != 0) {
        a = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0].textContent
        a = a.split(' ')
...
async function buttonsFromDoc(butName) { // функция отправки шаблона в зависимости от нажатой кнопки и также взаимодействут с другими функциями
    ...
    if (butName == 'Привет') {
        if (document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0]) {
            a = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[0].textContent
        } 
        a = a.split(' ')
        const cyrillicPattern = /^[\u0400-\u04FF]+$/;
...
function refreshTemplates() { // функция обновляет шаблоны которые загружены были с гугл таблицы и сформированы их в table
    setInterval(function () {
		...
		if (document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children.length>1) {
			let perechen = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[4].children[0].children[0]
		} else perechen = undefined;



		if (perechen != undefined) {
			        if (document.getElementById('phone_tr') != undefined) {
			
			for (let i=0;i<perechen.childNodes.length;i++) {
				if (perechen.childNodes[i].childNodes[0].childNodes[0].textContent == "phone") {
					phone = perechen.childNodes[i].childNodes[0].childNodes[1].textContent
        ...
        if (document.getElementById('email_tr') != undefined) {
				...
				for (let i=0;i<perechen.childNodes.length;i++) {
					if (perechen.childNodes[i].childNodes[0].childNodes[0].textContent == "email" || perechen.childNodes[i].childNodes[0].childNodes[0].textContent == "identity") {
						email = perechen.childNodes[i].childNodes[0].childNodes[1].textContent

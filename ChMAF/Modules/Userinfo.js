        ...
        <span style="width: 320px">
                <span style="cursor: -webkit-grab;">
                        <div style="width: 320px; padding: 5px; border-bottom:1px solid #556B2F;" id="servicehead">
								...
								<button title="Делаем видимым номер телефона и почты" id='dounhidemailandphone'><img src="https://dimentorexpo.github.io/ChMAF/Images/sauron.png" alt="👁‍🗨" width="20" height="20" vertical-align="top"></button>

...
document.getElementById('multitag').onclick = function () { // откправка нескольких тэгов (мультитэг)
	...
	let b = document.getElementsByClassName('NEW_FRONTEND__expert')[0].contentDocument.children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[1].children

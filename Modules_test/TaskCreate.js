        ...
        <span style="width: 414px">
                <span style="cursor: -webkit-grab;">
                        ...
                        <div style="margin: 5px; margin-top: 0px; width: 410px" id="create_form_menu">
                            ...
                            <span id="NoteNoticeText" title="При нажатии на тест отправка заметки будет отменена" style="background:#69a4c7; color:#fff;  font-weight:300; border:1px solid black; display:none;"></span>
                            <button id="NoteNoticebtn" title="При нажатии на тест отправка заметки будет отменена" style="display:none; margin-right:5px; float: right;">🚫</button>

	...
	<div style="border: 2px double black; display: none; background-color: #464451" id="set_bar">
		<div style="margin: 5px; width: 350px">
			...
			<div style="margin: 5px; width: 350px">
				...
				<button title="Переключает на другой документ с шаблонами с иконками возле имен кнопок. После нажатия обновите страницу для применения изменений" id="type_TP_eng">ENG</button>
				</p>
			</div>
...
var TP_addr3 = 'https://script.google.com/macros/s/AKfycbwhPFAPSth4KF7CIoZrxpUf2M3CsirqHZFRPHsZ2wqD6L4I3bC1y1Ko0aX0_9zmvM83/exec'
var flagLangBut = 0
function move_again_AF() {
    ...
    document.getElementById('snd').onclick = function () {
        ...
        if (document.getElementById('msg').innerHTML == "Chat") {
            if (template_flag == 1) {
                if (template_flag2 == 1)

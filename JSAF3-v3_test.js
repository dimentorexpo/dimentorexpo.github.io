...
var win_serviceinfo =  // описание элементов окна ссылок
    `<div style="display: flex; width: 300px;">
        <span style="width: 300px">
                <span style="cursor: -webkit-grab;">
                        <div style="margin: 5px; width: 300px;" id="servicehead">
...
document.getElementById('getidstudent').onclick = function () {
	...
	function getServInfo() {
        ...
        document.getElementById('sendResponse').click()
			...
			servinfo += 'ID Услуги: ' + servicearr.data[i].id + '<span class = "copyserviceid" style="margin-left: 5px; cursor: pointer">💾</span>' + '<br> Баланс: ' + servicearr.data[i].balance + '<br> STK: ' + servicearr.data[i].serviceTypeKey + '<hr style="width:260px;">';

        ...
        <span style="width: 550px">
			<span style="cursor: -webkit-grab;">
				...
				<div style="margin: 5px; width: 550px" id="links_butd">	
					...
					<button title="отображает актуальную версию iOS приложения" id="curVeriOS" style="float: right; margin-right: 10px;">iOS: 9.65</button>
    ...
    `<div style="display: flex; width: 465px;">
        ...
        <span style="cursor: -webkit-grab;">
                ...
                <div id="servicedeskinfo" style="margin-left:20px;">
                    ...
                    <button class="sdbtn" id="optionMrktprojbugs" style="margin-left:2px; margin-top:2px; width:80px;">👨‍💻mrproject</button>
                </div>

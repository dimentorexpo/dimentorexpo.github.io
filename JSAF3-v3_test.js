		...
		async function getlessoninfo() {
			...
			for (let i=0;i<joinresult.lessonPlan.Homework.length;i++) {
				if (joinresult.currentStepRevId == joinresult.lessonPlan.Homework[i].id) {
					console.log('Курс: ' + joinresult.lessonInfo.info.program + ' Уровень: ' + joinresult.lessonInfo.info.levelText + ' Урок: '  + joinresult.lessonInfo.info.title + ' Слайд: '  + joinresult.lessonPlan.Homework[i].title +'\n' + 'CMS общая ссылка: https://content.vimbox.skyeng.ru/cms/lesson/update/id/' + joinresult.lessonId + ' CMS ссылка на активный слайд: https://content-vimbox.skyeng.ru/cms/stepStore/update/stepId/' + joinresult.lessonPlan.Homework[i].stepUUID)
					...
					alert('Информация скопирована уже в буфер обмена!!!' + 'Курс: ' + joinresult.lessonInfo.info.program + ' Уровень: ' + joinresult.lessonInfo.info.levelText + ' Урок: '  + joinresult.lessonInfo.info.title + ' Слайд: '  + joinresult.lessonPlan.Homework[i].title +'\n' + 'CMS общая ссылка: https://content.vimbox.skyeng.ru/cms/lesson/update/id/' + joinresult.lessonId + ' CMS ссылка на активный слайд: https://content-vimbox.skyeng.ru/cms/stepStore/update/stepId/' + joinresult.lessonPlan.Homework[i].stepUUID)
					}
			}
		}
    }

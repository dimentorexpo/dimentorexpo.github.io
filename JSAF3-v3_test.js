        ...
        <span style="width: 350px">
                <span style="cursor: -webkit-grab;">
						...
						<div id="svyazissues" style="margin-left:20px;display:flex; flex-wrap:wrap;display:none">
								...
								<button name="themesbtn" value="1581" title="Проблемы со связью возникли из-за того, что версия операционной системы или браузера ниже минимальных для работы на платформе" style="margin-left:2px; width:150px; height: 44px;">Версии ПО (ОС/браузер) ниже минимальных</button>
								<button name="themesbtn" value="1582" title="Проблемы со связью возникли из-за корпоративного устройства или корпоративной сети пользователя" style="margin-left:2px; width:150px; height: 44px;">Корп.сеть/устройство</button>
								<button name="themesbtn" value="1583" title="Проблемы со связью возникли из-за неполадок с браузером и/или операционной системы пользователя" style="margin-left:2px; width:150px; height: 44px;">Неполадки ОС/браузер</button>
								<button name="themesbtn" value="1584" title="Проблемы со связью возникли из-за неполадок с гарнитурой (устройствами ввода и вывода звука), конкретно из-за индивидуальных настроек конкретной модели или физического дефекта/поломки. В эту же категорию попадают кейсы в которых пользователь случайно отключил микрофон или уменьшил громкость через кнопку на наушниках/микрофоне" style="margin-left:2px; width:150px; height: 44px;">Неполадки с гарнитурой</button>
								<button name="themesbtn" value="1585" title="Проблемы со связью возникли из-за неполадок с камерой (физические неисправности, не было разрешений в браузере/устройстве, блокировка антивирусом, индивидуальные настройки конкретной модели устройства)" style="margin-left:2px; width:150px; height: 44px;">Неполадки с камерой</button>
								<button name="themesbtn" value="1586" title="Проблемы со связью возникли из-за несоответствия минимальным требованиям, перегруженность ЦП, ОЗУ. Неактуальные версии ОС." style="margin-left:2px; width:150px; height: 44px;">Неполадки с ПК</button>
								<button name="themesbtn" value="1587" title="Проблемы со связью возникли из-за скорости интернета ниже 5 Мбит/сек в оба направления (скачать/загрузить)" style="margin-left:2px; width:150px; height: 44px;">Характеристики интернета ниже минимальных</button>
								<button name="themesbtn" value="1588" title="Проблемы со связью возникли из-за несоответствия показателей устройства минимальным критериям" style="margin-left:2px; width:150px; height: 44px;">Характеристики устройства ниже минимальных</button>
								<button name="themesbtn" value="1589" title="Пользователю потребовалось разъяснение по работе связи в уроке, как заходить в урок, что нажимать, как установить связь с преподавателем/учеником." style="margin-left:2px; width:150px; height: 44px;">Консультация работы связи на платформе</button>
								<button name="themesbtn" value="1590" title="Причину блокирования или прерывания связи не удалось обнаружить и при проверке связи на тестовом уроке всё работало хорошо" style="margin-left:2px; width:150px; height: 44px;">Сбой на платформе - блокировалась / прерывалась связь</button>
								<button name="themesbtn" value="1591" title="Причину аудио: задержки или искажения связи не удалось обнаружить и при проверке связи на тестовом уроке всё работало хорошо" style="margin-left:2px; width:150px; height: 44px;">Сбой на платформе - аудио: задержки / искажения</button>
								<button name="themesbtn" value="1592" title="Причину видео: задержки или плохой картинке связи не удалось обнаружить и при проверке связи на тестовом уроке всё работало хорошо" style="margin-left:2px; width:150px; height: 44px;">Сбой на платформе - видео: задержки / плохая картинка</button>
								...
								P.S. Эта категория используется в случае если сбой не подходит ни под какую подтему в этой теме"" style=""margin-left:2px; width:150px; height: 44px;"">Сбой на платформе</button>"
								<button name="themesbtn" value="1594" title="Проблемы со связью возникли по причине использования браузера, несоответствующему минимальным требованиям." style="margin-left:2px; width:150px; height: 44px;">Платформа не поддерживает браузер/ОС</button>
								<button name="themesbtn" value="1595" title="Проблемы со связью возникли по причине использования устройства (камера/гарнитура/ПК), которые не соответствуют минимальным требованиям, не поддерживаются платформой (гарнитура от телефона и т.п.)" style="margin-left:2px; width:150px; height: 44px;">Платформа не поддерживает устройство (камера/гарнитура/ПК)</button>
						</div>

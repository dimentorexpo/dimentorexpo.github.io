        ...
        <span style="width: 550px">
			<span style="cursor: -webkit-grab;">
				...
				<div style="margin: 5px; width: 550px" id="links_butd">	
					...
					<button id="curVeriOS" style="float: right; margin-right: 10px;">iOS: 9.39</button>
...
document.getElementById('parsechat').onclick = async function() {
    ...
    try {
        ...
        await fetch("https://skyeng.autofaq.ai/api/conversations/history", {
            ...
            "body": "{\"serviceId\":\"361c681b-340a-4e47-9342-c7309e27e7b5\",\"mode\":\"Json\",\"usedAutoFaqKbIds\":[\"120181\"],\"participatingOperatorsIds\":[\"" + operatorId + "\"],\"tsFrom\":\"" + datefrom2 + "\",\"tsTo\":\"" + dateto2 + "\",\"usedStatuses\":[\"ClosedByOperator\"],\"orderBy\":\"ts\",\"orderDirection\":\"Asc\",\"page\":" + pagecmt +",\"limit\":100}",
            "method": "POST",
        }).then(r => r.json()).then(r => test = r)
        for (let i = 0; i < test.items.length; i++) {
            let flagComment = 0

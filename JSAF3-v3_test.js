...
function move_again_AF() {
    ...
    function clock_on_javascript_1() {
		...
		if (localStorage.getItem('setchas') - hours < 0 || localStorage.getItem('setminuta') - minutes < 0) {
			...
			} else if (localStorage.getItem('setchas') - hours >= 0 && localStorage.getItem('setchas') - hours == 1 || localStorage.getItem('setminuta') - minutes >= 0) {
				time = (localStorage.getItem('setchas') - hours-1) + " : " + (localStorage.getItem('setminuta') - minutes-1) + " : " + (60 - seconds);
			document.getElementById("clock_remin").innerHTML = time; 
			} else if (localStorage.getItem('setchas') - hours >= 0 && localStorage.getItem('setchas') - hours > 1 || localStorage.getItem('setminuta') - minutes >= 0) {

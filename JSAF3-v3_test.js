        ...
        async function getJiraTask() {
            ...
            if (rezissuetable == null)
                ...
                for (let i = 0; i < rezissuetable.issueTable.issueKeys.length; i++) {
					...
					} else if (rezissuetable.issueTable.issueKeys[i] != undefined || document.getElementById('testJira').value == "portfolio" || document.getElementById('testJira').value == "Portfolio" || document.getElementById('testJira').value == "Портфолио" || document.getElementById('testJira').value == "портфолио" || document.getElementById('testJira').value == "404" || document.getElementById('testJira').value != "403" || document.getElementById('testJira').value == "recording" || document.getElementById('testJira').value == "record" || document.getElementById('testJira').value == "recording" || document.getElementById('testJira').value == "ситуации" || document.getElementById('testJira').value == "ios" || document.getElementById('testJira').value == "android") {

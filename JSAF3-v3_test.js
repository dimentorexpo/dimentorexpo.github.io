...
async function remandressl() {
	if (document.URL.split('/').length > 4 && document.URL.split('/')[3] != 'portfolio' && document.URL.split('/')[2] != 'skyeng.autofaq.ai'  && document.URL.split('/')[3] !== 'circles') {
    ...
    try {
        if (document.location.pathname.split('/')[3] == undefined || document.location.pathname.split('/').length >4)
			...
			if (document.URL.split('/').length> 4) { 
				...
				if (diftime>1 && document.getElementById('znakvnimanie').innerText != "~25м💥" ) {

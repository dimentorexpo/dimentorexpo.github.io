    ...
    function getServInfo() {
        ...
        for (let i = 0; i < servicearr.data.length; i++) {
            if (servicearr.data[i].incorrectnessReason == null && servicearr.data[i].stage != "lost" && servicearr.data[i].teacher != null &&  servicearr.data[i].temporaryTeacher == null) {
                ...
                servinfo +='<span style="color:#32CD32; font-weight:900;">Teacher Info</span><br>' + Object.values(servicearr.data[i].teacher.general) + "<br>" + '<span class = "iduslugitxt">ID Услуги: </span>' + servicearr.data[i].id + '<span class = "copyserviceid" style="margin-left: 5px; cursor: pointer">💾</span>' + '<br> Баланс: ' + servicearr.data[i].balance + '<br> STK: ' + servicearr.data[i].serviceTypeKey + '<hr style="width:260px; border: 1px dotted #ff0000;  border-style: none none dotted; color: #fff; background-color: #fff;">';
                arrservice += servicearr.data[i].id + ", "
            } else if (servicearr.data[i].teacher == null && servicearr.data[i].temporaryTeacher != null) {

               
                servinfo +='<span style="color:#32CD32; font-weight:900;">Teacher Info</span><br>' + Object.values(servicearr.data[i].temporaryTeacher.general) + "<br>" + '<span class = "iduslugitxt">ID Услуги: </span>' + servicearr.data[i].id + '<span class = "copyserviceid" style="margin-left: 5px; cursor: pointer">💾</span>' + '<br> Баланс: ' + servicearr.data[i].balance + '<br> STK: ' + servicearr.data[i].serviceTypeKey + '<hr style="width:260px; border: 1px dotted #ff0000;  border-style: none none dotted; color: #fff; background-color: #fff;">';
                arrservice += servicearr.data[i].id + ", "
                ...
                servinfo += '<span style="color:#32CD32; font-weight:900;">Teacher Info</span><br>' + "KGL student" + "<br>" + '<span class = "iduslugitxt">ID Услуги: </span>' + servicearr.data[i].id + '<span class = "copyserviceid" style="margin-left: 5px; cursor: pointer">💾</span>' + '<br> Баланс: ' + servicearr.data[i].balance + '<br> STK: ' + servicearr.data[i].serviceTypeKey + '<hr style="width:260px; border: 1px dotted #ff0000;  border-style: none none dotted; color: #fff; background-color: #fff;">';
                arrservice += servicearr.data[i].id + ", "
                ...
                servinfo += '<span style="color:#32CD32; font-weight:900;">Teacher Info</span><br>' + Object.values(servicearr.data[i].teacher.general) + "<br>" + '<span style="color:#FF8C00; font-weight:900;">Temporary Teacher Info</span><br>' + Object.values(servicearr.data[i].temporaryTeacher.general) + "<br>" + '<span class = "iduslugitxt">ID Услуги: </span>' + servicearr.data[i].id + '<span class = "copyserviceid" style="margin-left: 5px; cursor: pointer">💾</span>' + '<br> Баланс: ' + servicearr.data[i].balance + '<br> STK: ' + servicearr.data[i].serviceTypeKey + '<hr style="width:260px; border: 1px dotted #ff0000;  border-style: none none dotted; color: #fff; background-color: #fff;">';
                arrservice += servicearr.data[i].id + ", "

                ...
                <span style="cursor: -webkit-grab;">
                        ...
                        <div style="margin: 5px; margin-top: 0px; width: 410px" id="refuse_form_menu">
							...
							<select id="userissue" style="height: 25px; margin-top:5px;">
									...
									<option value="Проблема с демонстрацией экрана У">Проблема с демонстрацией экрана У</option>
									<option value="Проблема с демонстрацией экрана П">Проблема с демонстрацией экрана П</option>
							...
							<select id="howissuesolverd" style="width:410px; height: 25px;">
									...
									<option value="Отсутствие электроэнергии">Отсутствие электроэнергии</option>
        ...
        <span style="width: 550px">
			<span style="cursor: -webkit-grab;">
				<div style="margin: 5px; width: 550;" id="links_1str">
					...
					<button title="Открывает раздел для генерирования одноразового пароля для мобильного приложения" id="deleteaclnk" class="uplinksbar">🗑</button>

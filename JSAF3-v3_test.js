        ...
        <span style="width: 550px">
			<span style="cursor: -webkit-grab;">
				...
				<div style="margin: 5px; width: 550px" id="links_butd">	
					...
					<button title="отображает актуальную версию iOS приложения" id="curVeriOS" style="float: right; margin-right: 10px;">iOS: 9.53</button>
			  	    <button title="Отображает актуальную версию Android приложения" id="curVerAndroid" style="float: right; margin-right: 5px;">Аndroid: 9.44</button>
				</div>		
			</span>
	</span>
</div>`;
...
<span style="width: 430px">
        <span style="cursor: -webkit-grab;">
				...
				<div id="billingqasrvdskoptions" style="display: none;">
					...
					<button>Вопросы по рассрочке ученика</button>
					<button>Оплата с лендингов</button>
					<button>Проверка баланса У на расхождения</button>
				</div>
				...
				<div id="kidsform" style="display: none; margin:5px;">
					...
					<br>
					<input id="customfield_5" placeholder="ID Преподавателя" style="width: 420px;"></input>
					<br>
				...
				<div id="teachersform" style="display: none; margin:5px;">
					<input id="customfield_6" placeholder="ID Ученика" style="width: 420px;"></input>
					<br>
					<input id="customfield_7" placeholder="ID Преподавателя" style="width: 420px;"></input>
					<br>
					<textarea id="customfield_8" placeholder="Как воспроизвести ошибку?" style="width: 420px;"></textarea>
					<br>

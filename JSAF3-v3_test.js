...
async function checkthemestatus() {
    try {
        if (document.location.pathname.split('/')[3] == '' || document.location.pathname.split('/').length < 4)

   ...
   setTimeout(function() {
    ...
    function getServInfo() {
		...
		if(uid2 == "")
			...
			chrome.runtime.sendMessage({name: "ChM", question: 'get_login_link', id: uid2}, function(response) {

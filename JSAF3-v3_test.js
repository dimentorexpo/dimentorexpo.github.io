    ...
    `<div style="display: flex; width: 300px;">
        <span style="width: 300px">
                <span style="cursor: -webkit-grab;">
						...
						<input id="onetimepassout" placeholder="One time pass" title="Вывод разового пароля после выполнения команды" autocomplete="off" type="text" style="float:left; text-align: center; width: 60px; color: black;" class="">

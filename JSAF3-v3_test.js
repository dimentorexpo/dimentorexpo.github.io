...
async function gettpthemes() {
    ...
    console.log(count);
    found = "⏩SC/TC: " + count[1027] + '<br>' + "📱Jira🚧: " + count[1068] + '<br>' + "⛱ЛК консультация🧠: " + count[1034] + '<br>' + "📱🔀QA: " +
        count[1031] + '<br>' + "🔇Связь устр: " + count[1038] + '<br>' + "🔇Связь сбой: " + count[1040] + '<br>' + "🔇Связь инет: " + count[1037] +
        '<br>' + "🔀QA: " + count[1029] + '<br>' + "🔀2Л: " + count[1026] + '<br>' + "🔀Контент: " + count[1028] + '<br>' + "⛱ЛК сбой: " + count[1035] +
        '<br>' + "⛱ЛК инет/устр: " + count[1036] + '<br>' + "🔐Данные вход🔑: " + count[1048] + '<br>' + "🎎Дубль: " + count[1057] + '<br>' +
        "❌Отказ от помощи: " + count[1060] + '<br>' + "⛱ЛК, Jira🚧: " + count[1069] + '<br>' + "💲Ошибка при оплате: " + count[858] + '<br>' +
        "💲Понимание оплаты: " + count[859] + '<br>' + "📜Пожелания и предложения: " + count[1055] + '<br>' + "🔥Серв ЛК: " + count[1063] + '<br>' +
        "🔥Серв связь: " + count[1066] + '<br>' + "🔥Серв вх/подкл🔐: " + count[1065];

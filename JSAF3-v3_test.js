...
async function gettpthemes() {
    ...
    console.log(count);
    found = "⏩SC/TC: " + count[1027] + '<br>' + "📱Jira🚧: " + count[1068] + '<br>' + "📱🔀QA: " + count[1031] + '<br>' + "⛱ЛК консультация🧠: " +
        count[1034] + '<br>' + "🔇Связь устр: " + count[1038] + '<br>' + "🔇Связь сбой: " + count[1040] + '<br>' + "🔇Связь инет: " + count[1037] +

                ...
                for (let i = 0; i < arregetted[0].result[0].classes.length; i++) {
                    if (arregetted[0].result[0].classes[i].studentId == uchenikid) {
                        ...
                        if (arregetted[0].result[0].classes[i].classStatus !== undefined) {
							arregetted[0].result[0].classes[i].classStatus.createdByUserId == document.getElementById('idteacherforsearch').value ? arregetted[0].result[0].classes[i].classStatus.createdByUserId = arregetted[0].result[0].classes[i].classStatus.createdByUserId + '<span style="color:blue"> (П)</span>' : arregetted[0].result[0].classes[i].classStatus.createdByUserId = arregetted[0].result[0].classes[i].classStatus.createdByUserId
                            ...
                            text = text + ' | удален (проверить CRM на отпуск или удаление оператором) | дата удаления: ' + new Date(arregetted[0].result[0].classes[i].removedAt).toLocaleString("ru-RU", { timeZone: 'Europe/Moscow' });
                        }

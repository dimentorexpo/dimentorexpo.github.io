        ...
        <span style="width: 550px">
                <span style="cursor: -webkit-grab;">
						...
						<div id="control_jira_search">
							<button id="defaultQuery" title="Страница для поиска по умолчанию с заранее записанным JQL запросом" class="active-query" style="margin-left: 20%;">Default</button>

    ...
    document.getElementById('getenablerAP').onclick = function () {               // сохранение в буфере ссылки для активации АП
		...
		document.getElementById('getJiraTasks').onclick = function () { 
			setTimeout(function getJiraTask() {
			   ...
			   let issues =[];
			   for (let i=0; i<10; i++) {
				   issues += '<a href="https://jira.skyeng.tech/browse/' + rezissuetable.issueTable.issueKeys[i] + '" onclick="">https://jira.skyeng.tech/browse/' + rezissuetable.issueTable.issueKeys[i] + '</a></br>'				   
			   }

...
function paintstatus() {
    if (document.URL != "https://skyeng.autofaq.ai/tickets/archive") {
        if (document.querySelectorAll('.user_menu-status-name')[1] != undefined && document.querySelectorAll('.user_menu-status-name')[1] !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Офлайн" || document.querySelectorAll('.user_menu-status-name')[1].innerText == "Перерыв") {
        ...
        } else if (document.querySelectorAll('.user_menu-status-name')[1] != undefined && document.querySelectorAll('.user_menu-status-name')[1] !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Онлайн") {
        ...
        } else if (document.querySelectorAll('.user_menu-status-name')[1] != undefined && document.querySelectorAll('.user_menu-status-name')[1] !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Занят") {

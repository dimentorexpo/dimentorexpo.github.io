...
async function gettpthemes() {
    ...
    found = "⏩SC/TC: " + count[1027] + '<br>' + "📱Jira🚧: " + count[1068] + '<br>' + "📱🔀QA: " + count[1031] + '<br>' + "⛱ЛК консультация🧠: " +
        ...
        '<br>' + "⛱ЛК инет/устр: " + count[1036] + '<br>' + "⛱ЛК, Jira🚧: " + count[1069] + '<br>' + "🔐Данные вход🔑: " + count[1048] + '<br>' +
        "🎎Дубль: " + count[1057] + '<br>' + "❌Отказ от помощи: " + count[1060] + '<br>' + "💲Ошибка при оплате: " + count[858] + '<br>' +

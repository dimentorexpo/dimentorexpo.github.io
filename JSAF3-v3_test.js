...
button2.innerHTML = '<a style="cursor: pointer;">Info</a>';
let buttonhistory = document.createElement('p');
buttonhistory.id = 'lookForHistory';
buttonhistory.innerHTML = '<a style="cursor: pointer;">Chat History📋</a>';
let buttonmobpas = document.createElement('p');
buttonmobpas.id = 'copymobpass';
buttonmobpas.innerHTML = '<a style="cursor: pointer;">Generate code📱</a>';
...
buttonnextstudentid.innerHTML = '<a style="cursor: pointer;">Chat History📋(У)</a>';
...
buttonnextteacherid.innerHTML = '<a style="cursor: pointer;">Chat History📋(П)</a>';
...
buttonloc.innerHTML ='<a style=" cursor: pointer;">Изменить яз.обсл. на RU</a>';
let buttontechdatastudent = document.createElement('p');
buttontechdatastudent.id = 'getStudentUserAgentInfo';
buttontechdatastudent.innerHTML = '<a style=" cursor: pointer;">Получить инфо об устройстве У</a>';
let buttontechdatateacher = document.createElement('p');
buttontechdatateacher.id = 'getTeacherUserAgentInfo';
buttontechdatateacher.innerHTML = '<a style="cursor: pointer;">Получить инфо об устройстве П</a>';

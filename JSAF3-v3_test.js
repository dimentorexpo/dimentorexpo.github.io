        ...
        <span style="width: 410px">
			<span style="cursor: default;">
				...
				<div style="width: 410px;display:none" id="somechatinfo">
					...
					<button id="opencmtbar" style="margin-left:10px;" title="Открыть инструмент добавления комментария к чату">🚧</button>
					<button id="takechat" style="margin-left: 137px; margin-top:5px;" title="Забирает чат и назначает на вас,но некоторые чаты или у других коллег забраться не получится">Забрать</button>
					<br>

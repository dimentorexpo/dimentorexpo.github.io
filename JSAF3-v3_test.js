        ...
        <span style="width: 550px">
			<span style="cursor: -webkit-grab;">
				...
				<div style="margin: 5px; width: 550px" id="links_box">
					...
					<input id="idteacherkidcc" placeholder="ID П Kid KK💬" title="введите айди П для копирования команды в буфер обмена и выполнения ее после авторизации в профиль этого П для добавления чата с учениками Skysmart Компьютерных курсов (авторизовались - ввели айди и скопировали и выполнили в консоле)" autocomplete="off" type="text" style="text-align: center; width: 103px; color: black; margin-top: 5px">
					<button id="setchatskidscc" style="width: 25.23px;">💾</button> 
				...
				<div style="margin: 5px; width: 550px" id="links_butd">	
					...
					<button title="отображает актуальную версию iOS приложения" id="curVeriOS" style="float: right; margin-right: 10px;">iOS: 9.63</button>
			  	    <button title="Отображает актуальную версию Android приложения" id="curVerAndroid" style="float: right; margin-right: 5px;">Аndroid: 9.58</button>
...
function paintstatus() {
    if (document.URL != "https://skyeng.autofaq.ai/tickets/archive") {
        if (document.querySelectorAll('.user_menu-status-name')[1].innerText != undefined && document.querySelectorAll('.user_menu-status-name')[1].innerText !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Офлайн" || document.querySelectorAll('.user_menu-status-name')[1].innerText == "Перерыв") {
        ...
        } else if (document.querySelectorAll('.user_menu-status-name')[1].innerText != undefined && document.querySelectorAll('.user_menu-status-name')[1].innerText !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Онлайн") {
        ...
        } else if (document.querySelectorAll('.user_menu-status-name')[1].innerText != undefined && document.querySelectorAll('.user_menu-status-name')[1].innerText !=null && document.querySelectorAll('.user_menu-status-name')[1].innerText == "Занят") {

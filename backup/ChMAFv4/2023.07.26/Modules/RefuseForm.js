...
function hashrefuseform(){
    if (document.URL.split('/')[4] == 'assigned'){
        document.getElementById('chatlnk').value = "https://skyeng.autofaq.ai/logs/" + getActiveConvid()
    } else if (document.URL.split('/')[4] == 'archive'){
        document.getElementById('chatlnk').value = "https://skyeng.autofaq.ai/logs/" + getArhiveConvid()

...
var win_UsersInfo = // описание окна тестовых пользователей
    `<span style="display: block;">
       <span id="CurrUser" style="cursor:pointer;"></span>
       <button id="CurUsScriptPac" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">ℹ️</button>
       <button id="CurUsLoginer" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">🔑</button>
       <button id="CurUstroublesh" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">🕵️‍♀️</button>
       <button id="CurUsChatHis" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">☢</button>
       <button id="CurUsUserInf" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">⚜</button>
       <button id="CurUsMarks" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">📊</button>
   </span>
   <span id="nextUsersp" style="display: none;">
       <span id="NextUser" style="cursor:pointer;"></span>
       <button id="NextUsScriptPac" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">ℹ️</button>
       <button id="NextUsLoginer" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">🔑</button>
       <button id="NextUstroublesh" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">🕵️‍♀️</button>
       <button id="NextUsChatHis" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">☢</button>
       <button id="NextUsUserInf" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left: -8px; font-family:sans-serif,-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoEmoji,Twemoji;">⚜</button>
   </span>
   `;
...
function requestsRed(iframeDoc) {
 ...
 if (taketaskElement) {
   ...
   const observer = new MutationObserver(() => {
     highlightTaskElement(taketaskElement);
   });

   // Настраиваем наблюдение за изменениями содержимого элемента
   observer.observe(taketaskElement, { childList: true, subtree: true });
 }
}*/
...
function startTimer() {
    ...
    */
    ...
    if (hrefisnow.includes('skyeng.autofaq.ai/tickets/assigned') && Usernamefield && iframeDoc.getElementsByClassName('UsersInfo').length == 0) {
    ...
    } else if (hrefisnow.includes('skyeng.autofaq.ai/tickets/assigned') && Usernamefield && iframeDoc.getElementsByClassName('UsersInfo').length == 1) {
        if (getActiveConvid()!= nameContainer) {

...
document.getElementById('serviceinf').innerHTML = '';
    ...
    if (document.getElementById('AF_Createtask').style.display == 'none') {
        ...
        document.getElementById("responseTextarea1").addEventListener("DOMSubtreeModified", function () {
			...
			if (document.getElementsByTagName('iframe')[0].contentDocument.children[0].children[1].children[newFrameIndex].children[0].children[0].children[1].children[0].children[1].children[0].children.length != 1) {
				let perechenAF = document.getElementsByTagName('iframe')[0].contentDocument.children[0].children[1].children[newFrameIndex].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[4].children[0].children[0]
			  	for (let i=0;i<perechenAF.childNodes.length;i++) {
					if (perechenAF.childNodes[i].childNodes[0].childNodes[0].textContent == "nextClass-statusHTML") {
						 if (perechenAF.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт урок" || perechenAF.childNodes[i].childNodes[0].childNodes[1].textContent == "идет урок" || perechenAF.childNodes[i].childNodes[0].childNodes[1].textContent == "идет ВУ" || perechenAF.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт ВУ" || perechenAF.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт вводный урок") {
								document.getElementById('statusuroka').innerHTML = perechenAF.childNodes[i].childNodes[0].childNodes[1].innerHTML
		...
		if (document.getElementsByTagName('iframe')[0].contentDocument.children[0].children[1].children[newFrameIndex].children[0].children[0].children[1].children[0].children[1].children[0].children.length != 1) { 
				let perechen = document.getElementsByTagName('iframe')[0].contentDocument.children[0].children[1].children[newFrameIndex].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[4].children[0].children[0]

			for (let i=0;i<perechen.childNodes.length;i++) {
				if (perechen.childNodes[i].childNodes[0].childNodes[0].textContent == "nextClass-statusHTML") {
					 if (perechen.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт урок" || perechen.childNodes[i].childNodes[0].childNodes[1].textContent == "идет урок" || perechen.childNodes[i].childNodes[0].childNodes[1].textContent == "идет ВУ" || perechen.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт ВУ" || perechen.childNodes[i].childNodes[0].childNodes[1].textContent == "идёт вводный урок") {
							document.getElementById('statusuroka').innerHTML = perechen.childNodes[i].childNodes[0].childNodes[1].innerHTML
							document.getElementById('statusuroka').style = "background:rgb(70, 68, 81); padding:0px;"
					 } else {
							document.getElementById('statusuroka').innerHTML = "Урок не идет"
							document.getElementById('statusuroka').style = "background:#69a4c7; padding:5px; color:#fff;  font-weight:600; border:1px solid black;"
        ...
        document.getElementById('critteachertostudent').onclick = function () {
			...
			let sidebarUserInfo = document.getElementsByTagName('iframe')[0].contentDocument.children[0].children[1].children[newFrameIndex].children[0].children[0].children[1].children[0].children[1].children[0].children[1].children[1].children[0].children[0].children[1].children[0].children[0].children[0].children[1].children[0].children[0].children[4].children[0].children[0].children
			
				for (let i=0; i <sidebarUserInfo.length;i++) {
					
					if (sidebarUserInfo[i].children[0].children[0].textContent == "nextClass-studentId") {
						document.getElementById('taskuserid').value = sidebarUserInfo[i].children[0].children[1].textContent
					...
					if (sidebarUserInfo[i].children[0].children[0].textContent == "nextClass-educationServiceId") {
						document.getElementById('taskserviceid').value = sidebarUserInfo[i].children[0].children[1].textContent
        ...
        document.getElementById('critstudenttoteacher').onclick = function () {
			...
			for (let i=0; i <sidebarUserInfo.length;i++) {
					...
					if (sidebarUserInfo[i].children[0].children[0].textContent == "services") {
						services = sidebarUserInfo[i].children[0].children[1].innerText.match(/service-\d+/gm)

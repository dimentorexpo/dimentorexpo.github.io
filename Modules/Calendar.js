	...
	document.getElementById("responseTextarea1").addEventListener("DOMSubtreeModified", function () {
		...
		let availableslotsentries = Object.entries(responseslotsdata.DataTimeSlot)
			for (let i=0; i< availableslotsentries.length;i++) {
				...
				} else if (availableslotsentries[62][1].CountEvent / availableslotsentries[62][1].CountSlot > 0 && availableslotsentries[62][1].CountEvent / availableslotsentries[62][1].CountSlot <1) {

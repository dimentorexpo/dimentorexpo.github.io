		...
		let availableslotsentries = Object.entries(responseslotsdata.DataTimeSlot)
			for (let i=0; i< availableslotsentries.length;i++) {
				...
				if (availableslotsentries[i][1].CountEvent / availableslotsentries[i][1].CountSlot == 1 ) {
					tempor.setAttribute('style', 'width: 50%; height: 20px; color: white; font-weight:700; background:rgb(171 65 62); border:1px solid; font-size:12px; height:25px; margin-bottom:2px; text-align:center;');
				} else if (availableslotsentries[i][1].CountEvent / availableslotsentries[i][1].CountSlot == 0) {
					tempor.setAttribute('style', 'width: 50%; height: 20px; color: white; font-weight:700; background:rgb(62 158 83); border:1px solid; font-size:12px; height:25px; margin-bottom:2px; text-align:center;');

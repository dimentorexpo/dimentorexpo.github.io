        ...
        <span style="width: 414px">
                <span style="cursor: -webkit-grab;">
                        ...
                        <div style="margin: 5px; margin-top: 0px; width: 410px" id="create_form_menu">
							...
							<br>
							<label style="color:bisque;">Используйте кнопку ниже для открытия создания задачи в СРМ на техподдерожку 2 линии с обязательным выбором Темы обращения "Запланированная связь с пользователем" Другие задачи на 2ЛТП передаем в прежнем режиме через это окно.</label>
							<br>
